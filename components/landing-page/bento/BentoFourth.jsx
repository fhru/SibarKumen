...
export default function BentoFourth() {
  return (
    <div className="md:col-span-2 p-4 md:p-6 rounded-3xl bg-[#FFE9D6] dark:bg-[#7C2D12]">
      <div className="flex flex-col-reverse md:flex-row md:items-center">
        <div className="flex justify-end flex-col gap-2 md:gap-3">
          <h1 className="text-2xl md:text-4xl font-bold text-foreground">Riwayat & Rekap Data Barang</h1>
